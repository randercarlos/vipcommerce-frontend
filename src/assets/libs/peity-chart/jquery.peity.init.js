...
!function($) {
    ...
    PeityChart.prototype.init = function() {
        ...
        this.createPie("span.pie", ['cornflowerblue', '#d7d7d7', '#ffffff']);

        //line
        this.createLine(".line", 'cornflowerblue', '#169c81');

        //bar
        this.createBar('.bar', ["cornflowerblue", "#d7d7d7"]);

        //bar
        this.createBar('.bar_dashboard', ["cornflowerblue", "#d7d7d7"], 100);

        //donut
        this.createDonut('.donut', ["cornflowerblue", "#d7d7d7"]);

        //this would use data attributes specified in html
        this.createDonut('.data-attributes span');

        //live graph
        var updatingChart = this.createLine(".updating-chart",'cornflowerblue','#169c81', 64);
