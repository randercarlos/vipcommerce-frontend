...
!function($) {
    ...
    FlotChart.prototype.createCombineGraph = function(selector, ticks, labels, datas) {
        ...
        var options = {
            ...
            colors: ["cornflowerblue", "#1a2942", "#60b1cc"],
            tooltip: true,
            tooltipOpts: {
                defaultTheme: false
            },
        ...
        FlotChart.prototype.init = function() {
          ...
          var pcolors = ['cornflowerblue', '#1a2942'];
          ...
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);
            ...
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['cornflowerblue']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ["#60b1cc", "#bac3d2", "#4697ce","#6c85bd","cornflowerblue"];
